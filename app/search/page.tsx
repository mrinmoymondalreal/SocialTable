    ...
    <main className="mt-4 flex flex-col items-center gap-y-4 px-4">
      ...
      >
        <input
          ...
          ref={SearchRef}
          name="search"
          className="w-full placeholder:text-gray-500 outline-none px-4 py-2 rounded-md bg-black/40"
          placeholder="Search Here..."
        />
        <button
          type="submit"
          className="border border-gray-700 px-4 py-2 rounded-md bg-black/40"
        >
          Search
        </button>
      </form>
